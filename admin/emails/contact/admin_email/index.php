		...
		<div class="card-body">
			<form action="confirm/check.php" method="POST" id="contat_email_form_to_admin">
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="sender_name" placeholder="Sender" name="sender_name" value="<?php echo populatedOrData(getPopulateData('sender_name'),getValueByKey("contact_email_sender_name_to_admin")); ?>">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="sender_address" placeholder="Sender Address" name="sender_address" value="<?php echo populatedOrData(getPopulateData('sender_address'),getValueByKey("contact_email_sender_addresss_to_admin")); ?>">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="admin_address" placeholder="Admin Address" name="admin_address" value="<?php echo populatedOrData(getPopulateData('admin_address'),getValueByKey("contact_email_admin_address_to_admin")); ?>">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="subject" placeholder="Subject" name="subject" value="<?php echo populatedOrData(getPopulateData('subject'),getValueByKey("contact_email_subject_to_admin")); ?>">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <textarea class="" id="body" placeholder="Body" name="body"><?php echo populatedOrData(getPopulateData('body'),getValueByKey("contact_email_body_to_admin")); ?></textarea>
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <textarea class="form-control" id="footer" placeholder="Footer" name="footer"><?php echo populatedOrData(getPopulateData('footer'),getValueByKey("contact_email_footer_to_admin")); ?></textarea>
