...
?>
	<div class="card">
		<div class="card-header">
			Application Email (user)
		</div>
		<div class="card-body">
			<form action="confirm/check.php" method="POST" id="contat_email_form_to_user">
			  <div class="form-group row">
			    <label for="sender_name" class="col-sm-2 col-form-label">Sender</label>
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="sender_name" placeholder="Sender" name="sender_name" value="<?php echo populatedOrData(getPopulateData('sender_name'),getValueByKey("application_email_sender_name_to_user")); ?>">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="sender_address" placeholder="Sender Address" name="sender_address" value="<?php echo populatedOrData(getPopulateData('sender_address'),getValueByKey("application_email_sender_addresss_to_user")); ?>">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="subject" placeholder="Subject" name="subject" value="<?php echo populatedOrData(getPopulateData('subject'),getValueByKey("application_email_subject_to_user")); ?>">
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <textarea class="" id="body" placeholder="Body" name="body"><?php echo populatedOrData(getPopulateData('body'),getValueByKey("application_email_body_to_user")); ?></textarea>
			  ...
			  <div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <textarea class="form-control" id="footer" placeholder="Footer" name="footer"><?php echo populatedOrData(getPopulateData('footer'),getValueByKey("application_email_footer_to_user")); ?></textarea>
		...
		<div class="card-footer">
			<button type="submit" class="btn btn-primary" onclick="submitForm('#contat_email_form_to_user')">Submit</button>
		</div>
	</div>
